...
public class Constants {
    ...
    public static final String UPLOAD_PLAYLIST = "PL-ByhnvzTpbSXSh2Ne9N4FD1s54YEsWfh";
    public static final String APP_NAME = "Proyek skripsi";
}
