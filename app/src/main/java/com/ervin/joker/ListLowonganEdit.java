...
public class ListLowonganEdit extends Fragment {
    ...
    String rawBatasKiriman;
    String rawTanggalTerbit;
    private String abu;
    private String jenis_pengguna;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<LowonganPekerjaan, LowonganPekerjaanAdapter>(LowonganPekerjaan.class, R.layout.layout_item_pekerjaan, LowonganPekerjaanAdapter.class, myRef.orderByChild("pembuat_lowongan").equalTo(user.getUid())) {
            ...
            protected void populateViewHolder(final LowonganPekerjaanAdapter viewHolder, final LowonganPekerjaan model, final int position) {
                ...
                int day = (int) TimeUnit.MILLISECONDS.toDays(expired - available);
                ...
                viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        vibe.vibrate(50);
                        abu = mFirebaseAdapter.getRef(position).getKey();
                        ...
                        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                jenis_pengguna = dataSnapshot.child("User").child(pembuatLowongan).getValue(User.class).getJenis_pengguna();
                                Log.d(TAG, "nyobaaaaa aja" + jenis_pengguna);
                                SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
                                rawTanggalTerbit = formatter.format(new Date(tanggalTerbit));
                                rawBatasKiriman = formatter.format(new Date(batasPengiriman));
